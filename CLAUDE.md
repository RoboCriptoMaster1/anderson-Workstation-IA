...
O ambiente principal da Workstation IA utiliza:
...
Outras linguagens poderão ser utilizadas quando justificadas pelo projeto.
...
Quando identificar melhorias relevantes:

1. Executar primeiro a solicitação principal.
...
Sempre buscar equilíbrio entre:
